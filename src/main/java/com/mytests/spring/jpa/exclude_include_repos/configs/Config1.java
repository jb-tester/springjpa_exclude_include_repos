...
import com.mytests.spring.jpa.exclude_include_repos.utils.annotations.MyFilterAnnotation2;
...
@EnableJpaRepositories(basePackages = "com.mytests.spring.jpa.exclude_include_repos.repositories",excludeFilters = {
        ...
        @ComponentScan.Filter(MyFilterAnnotation2.class),
